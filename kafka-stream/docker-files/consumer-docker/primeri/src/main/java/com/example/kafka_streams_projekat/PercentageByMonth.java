...
public class PercentageByMonth {

	public static void main(String[] args) {
		final Properties streamsConfiguration = KafkaStreamsUtil.getStreamsConfiguration("percentage-by-month");
		...
		flights.map((Long key, String value) -> {
			...
			return new KeyValue<>(words[2], new FlightFields(parseDouble(words[44]),
