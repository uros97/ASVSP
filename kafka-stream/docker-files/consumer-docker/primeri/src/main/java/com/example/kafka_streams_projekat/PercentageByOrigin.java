...
public class PercentageByOrigin {
	
	public static void main(String[] args) {
		final Properties streamsConfiguration = KafkaStreamsUtil.getStreamsConfiguration("percentage-by-origin");
		...
		flights.map((Long key, String value) -> {
			...
			String returnKey = words[11] + "|" + words[18] + "|" + words[15] + "|" + words[14];
			return new KeyValue<>(returnKey, new FlightFields(parseDouble(words[44]),
		...
		// .to(KafkaConstants.TOPIC_NAME + "-origin-percentage",
